    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
        ...
        <li class="menu-item">
            ...
            <ul id="order-page" class="collapse" aria-labelledby="order-page" data-parent="#side-nav-accordion">
                <li> <a href="tfrecordjsp">退房记录</a> </li>
                <li> <a href="index.jsp">清退记录</a> </li>
                <li> <a href="index.jsp">花名册</a> </li>
                <li> <a href="index.jsp">来文记录</a> </li>
                <li> <a href="index.jsp">购房合同记录</a> </li>
                <li> <a href="index.jsp">轮候查询</a> </li>
