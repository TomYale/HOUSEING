...
<%@ page import="com.house.domain.Waiting" %>
...
%>
<%
    List<Waiting> tfrecordList = (List<Waiting>)request.getAttribute("list");
%>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover thead-primary" style="text-overflow: ellipsis;white-space: nowrap;overflow: hidden;">
                                ...
                                <tr>
                                    ...
                                    <td><%=d.getIdc()%></td>
                                    <td><%=d.getLrtime()%></td>
                                    <td><%=d.getIntention()%></td>
                                    <td><%=d.getWaitingfx()%></td>
                                    <td><%=d.getRownumber()%></td>
                                    <td><%=d.getFirst()%></td>
                                    <td><%=d.getReason()%></td>
                                    <td><%=d.getWtype()%></td>
                                    <td><%=d.getFprecord()%></td>
